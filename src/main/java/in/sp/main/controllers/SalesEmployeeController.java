...
public class SalesEmployeeController 
{
	...
	ResponseEntity<SalesEmployeeDTO> insertSalesEmployeeDTO(@RequestBody SalesEmployeeDTO salesEmployeeDTO ) throws NameIsNullException
	{
    ...
    public ResponseEntity<SalesEmployeeDTO> updateSalesEmployeePartially(@RequestBody SalesEmployeeDTO salesEmployeeDTO) throws NameIsNullException, EmailIsNullException, JoinedDateNullException
    {
